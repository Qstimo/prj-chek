 ...
 * Остальным `SuperadminGuard` отвечает `403`: правило нераскрытия защищает
 * сведения о том, какие проекты существуют, а существование раздела
 * администрирования секретом не является.
 */
@Controller('servers')
