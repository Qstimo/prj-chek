...
Реализованы этапы 1 «Фундамент» и 2 «Инфраструктура»: аутентификация
с двухфакторной проверкой, проекты с секцией «Инфо», модель выдач доступа,
журнал действий, окружения проекта с серверными параметрами и доменами.
На уровне «метаданные» секция инфраструктуры показывает имя, вид и домены
окружения, не раскрывая серверных параметров; автопроверки статуса появятся
на этапе 6.
